...
<style>  
body{margin:0;font-family:Arial;background:#0b132b;color:#fff}  
header{background:#1c2541;padding:15px;text-align:center}  
header h1{margin:0;color:#5bc0be;letter-spacing:2px}  
nav{display:flex;justify-content:center;gap:15px;background:#3a506b;padding:10px}  
nav a{color:#fff;text-decoration:none;font-weight:bold}  
nav a:hover{color:#5bc0be}  
.container{display:flex;flex-wrap:wrap;padding:15px}  
.matches{flex:3}  
.bet-slip{flex:1;background:#1c2541;padding:15px;margin-left:10px;border-radius:8px}  
...
<h3>BILETA</h3>  
<ul id="slip"></ul>  
<p>Koeficient total: <span id="total">1.00</span></p>  
